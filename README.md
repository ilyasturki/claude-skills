...
| `/vet` | Test a recent change end-to-end with the right harness (bash, browser, or computer use), then run `/simplify` to clean up the changed code before wrapping up. | Yes | Partial |
